...
<p align="center">
  <strong>Стажер на позицию Frontend разработчика</strong><br>
...
Студент 4 курса специальности «Информационные системы и программирование» ИСПО ФГАОУ ВО СПбПУ.
Знаком с основами веб-разработки: HTML, CSS, JavaScript, Git, а также взаимодействием с API и инструментами отладки.
Готов применять знания на практике и развиваться в сфере Frontend-разработки.
